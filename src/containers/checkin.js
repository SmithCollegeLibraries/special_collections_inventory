...
const update = async () => {
    ...
    if(barcode.length === 15 && barcode.startsWith('310')){
        ...
        if(verifyBarcode && verifyBarcode.code === 201){
            ...
            //     if(verifyBarcode && verifyBarcode.results && verifyBarcode.results.location_needed !== "0"){
            ...
            //         }
            //     } else {
            //         if(window.confirm(`This item has already been checked in and is attached to location ID: ${verifyBarcode.results.location_needed}. Do you want to check it in again?`)){
            //             const updateBarcode = await containers(updateValue, 'container-check-in')
            //             if(updateBarcode && updateBarcode.code === 201){
            //                 setBarcode('')
            //                 success('Container successfully updated')
        ...
        <div className="container-fluid" style={{marginTop: "30px"}}>
            ...
            <Row>  
                <Col xs="4">
                    ...
                    <h1 className="display-4">Check In With Location <Button color="primary" onClick={e => reset(e)}>Next Location</Button></h1>
